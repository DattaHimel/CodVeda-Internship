////I have scrapped data from this website 'https://www.scrapethissite.com/pages/forms/' by using BeautifulSoup and requests libraries. Then stored it in CSV format.////
//Here is the code//

[Task_1.ipynb](https://github.com/user-attachments/files/23447434/Task_1.ipynb)
{
 "cells": [
  {
   "cell_type": "code",
   "execution_count": 1,
   "id": "ef679104-edc3-4990-8b0b-2e56228ca1ab",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 2,
   "id": "c8bc0b62-765b-45bc-9b30-3e95e2a0d6cc",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 3,
   "id": "c34ee8e1-c5df-4d45-a54b-083eb13f86e9",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 4,
   "id": "650ffbe0-7fbf-4113-9aab-d0119231c1ed",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 6,
   "id": "75332f11-d402-43d2-af26-3eed12860b91",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 7,
   "id": "b13488ae-9327-4099-8724-722f419f3745",
   "metadata": {},
   "outputs": [],
   "source": [
    "data = []"
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 8,
   "id": "1258fd13-719f-44b5-a697-9440dd8e28b2",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 10,
   "id": "7e963ac7-1f59-4a29-80d3-941940d5d834",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 11,
   "id": "6df62d65-1c26-4acb-bf5c-57233aedbc8f",
   "metadata": {},
   "outputs": [],
   "source": [
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 12,
   "id": "0d9c1c2f-9a65-47b1-9beb-3579c7284d00",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": 13,
   "id": "17ac3342-c3f9-4d1a-a04c-7d2c7d0c99cf",
   "metadata": {},
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   ...
   "id": "41cc9b45-1ced-4461-a9ec-402f1e559212",
   "metadata": {},
   "outputs": [],
   "source": []
  }
